...
const page108 = new Page({
  ...
  Non-orthogonal in practice due to not enough codes or imperfect\
  synchronization\
  Wikipedia: https:\
...
const page116 = new Page({
  ...
  content: "trol optimization, and visualizes the competiti\
  de the shaded region is a feasible vector of ta\
...
const page118 = new Page({
  ...
  How to prove convergence of DPC algorithm to a solution of this\
  optimization?\
  "
});
...
const page123 = new Page({
  ...
  Dominant strategy\
  A player's strategy that always leads to a payoff no worse than his any\
  other strategies, independent of his opponents' strategies\
