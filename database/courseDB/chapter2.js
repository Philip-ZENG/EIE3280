...
const section201 = new Section({
  ...
  tag: [Google,AdvertisementSpace, ClickthroughRate],
  tagIDs: [Google.tagID, AdvertisementSpace.tagID, ClickthroughRate.tagID],
...
const section202 = new Section({
  ...
  tag: [Auction, MultipleItemAuction],
  tagIDs: [Auction.tagID, MultipleItemAuction.tagID, ],
...
const section203 = new Section({
  ...
  tag: [Auction, SecondPriceAuction, Externality, SealedEnvelopAuction, TruthfulBidding, IndependentValuation],
  tagIDs: [Auction.tagID, SecondPriceAuction.tagID, Externality.tagID, SealedEnvelopAuction.tagID, TruthfulBidding.tagID, IndependentValuation.tagID],
